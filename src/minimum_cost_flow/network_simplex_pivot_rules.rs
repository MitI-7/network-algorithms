...
pub trait PivotRule<Flow> {
    ...
    fn find_entering_edge<'a, F: Fn(&InternalEdge<Flow>, &'a SpanningTreeStructure<Flow>) -> Flow>(&mut self, st: &'a SpanningTreeStructure<Flow>, calculate_violation: F) -> Option<usize>;
}
